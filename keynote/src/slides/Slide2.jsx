    ...
    <div className="slide">
      ...
      <div style={{ marginTop: '50px', display: 'flex', gap: '60px', justifyContent: 'center', flexWrap: 'wrap' }}>
        ...
        >
          ...
          <p style={{ fontSize: '1.8rem', marginTop: '15px' }}>Those starting a new<br/>laundry or dry cleaning business</p>
        </motion.div>
        ...
        >
          <span style={{ fontSize: '4rem' }}>📈</span>
          <p style={{ fontSize: '1.8rem', marginTop: '15px' }}>Those already running a business<br/>looking to improve & grow</p>
        </motion.div>
      </div>
    </div>
  )
