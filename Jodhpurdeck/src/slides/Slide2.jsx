...
const Slide2 = () => {
  return (
    <div className="slide" style={{
      ...
      >
        Jodhpur ka market<br />
        <span style={{ color: '#f59e0b' }}>aaj bhi traditional hai</span>
      </motion.h1>
      ...
      <div style={{
        ...
        >
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
            {['Walk-in dependent', 'Manual ops', 'Family-run'].map((item, i) => (
              <motion.li
                key={i}
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
        ...
        >
          ...
          >
            Customer expectations<br />are shifting
          </motion.p>
        </motion.div>

        {/* RIGHT ZONE - Future Direction */}
        <motion.div
          initial={{ opacity: 0, x: 50 }}
          animate={{ opacity: 1, x: 0 }}
