...
import offer2Image from '../hii.png'

const Slide3 = () => {
  const [revealed, setRevealed] = useState(false)

  const benefits = [
    'Automate day-to-day store operations',
    'Handle orders in a more organized and professional way',
    'Improve visibility and control in business processes',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            {benefits.map((benefit, index) => (
              ...
              >
                ...
                <span style={{ fontSize: '1.1rem', color: '#e0e0e0' }}>{benefit}</span>
              </motion.div>
            ))}
          </div>
        </motion.div>
      ...
      {!revealed ? (
        ...
        <AnimatePresence>
          ...
          >
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '20px', alignItems: 'center' }}>
                <div>
                  ...
                  <p style={{ fontSize: '1.6rem', color: '#e0e0e0', textDecoration: 'line-through' }}>₹36,000</p>
                </div>
                <div>
                  <p style={{ fontSize: '0.9rem', color: '#4fc3f7', textTransform: 'uppercase', letterSpacing: '1px' }}>Laundry Launchpad Special Price</p>
                  <p style={{ fontSize: '2rem', fontWeight: '700', color: '#4fc3f7' }}>₹24,000</p>
                </div>
              </div>
              <div style={{ borderTop: '1px solid rgba(255, 255, 255, 0.1)', paddingTop: '20px' }}>
                <p style={{ fontSize: '1.1rem', color: '#4caf50' }}>Your Benefit: Save ₹12,000 <strong>(33.33% OFF)</strong></p>
              </div>
            </motion.div>
            ...
            >
              This is for the person who is ready to stop thinking like a shopkeeper and start operating like a businessman.
            </motion.p>
          </motion.div>
        </AnimatePresence>
      )}
