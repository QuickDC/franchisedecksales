...
const Slide5 = () => {
  ...
  const includes = [
    'QDC software solution',
    'Stylish-looking POS machine',
    'Better counter experience',
    'More premium business presentation',
    'A stronger brand image in front of customers',
    'A more organized and modern business identity',
  ]
  ...
  return (
    <div className="slide" style={{ alignItems: 'flex-start' }}>
      ...
      {!revealed ? (
        ...
        >
          I want to be the best brand in the city
        </motion.button>
      ) : (
        <AnimatePresence>
          <motion.div
          ...
          >
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '20px', alignItems: 'center' }}>
                <div>
                  <p style={{ fontSize: '0.9rem', color: '#a0aec0', textTransform: 'uppercase', letterSpacing: '1px' }}>Actual Value</p>
                  <p style={{ fontSize: '1.6rem', color: '#e0e0e0', textDecoration: 'line-through' }}>₹1,30,000</p>
                </div>
                <div>
                  <p style={{ fontSize: '0.9rem', color: '#4fc3f7', textTransform: 'uppercase', letterSpacing: '1px' }}>Laundry Launchpad Special Price</p>
                  <p style={{ fontSize: '2rem', fontWeight: '700', color: '#4fc3f7' }}>₹99,999</p>
                </div>
              </div>
              <div style={{ borderTop: '1px solid rgba(255, 255, 255, 0.1)', paddingTop: '20px' }}>
                <p style={{ fontSize: '1.1rem', color: '#4caf50' }}>Your Benefit: Save ₹30,001 <strong>(23.08% OFF)</strong></p>
              </div>
            </motion.div>
            ...
            >
              This is for the owner who wants customers to feel that this is not an ordinary local shop — this is a modern, serious, growing brand.
            </motion.p>
          </motion.div>
        </AnimatePresence>
      )}
