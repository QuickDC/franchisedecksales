...
const Slide6 = () => {
  return (
    <div className="slide">
      ...
      >
        What If... Your Phone Never Missed A Call?
      </motion.h2>
      ...
      >
        <p style={{ fontSize: '1.5rem', color: '#a0aec0', fontStyle: 'italic', marginBottom: '20px' }}>
          Customer calls: "Is my suit ready?"
        </p>
        <p style={{ fontSize: '1.5rem', color: '#4fc3f7' }}>
          → AI answers: "Hi! Yes, your suit is ready. Pick up tomorrow 2-4pm?"
        </p>
      </motion.div>
      ...
      >
        24/7. Never on hold. Never misses a call.
      </motion.p>
      ...
      >
        70-80% of calls handled automatically. Recover lost customers you didn't know you were losing.
      </motion.p>
    </div>
  )
}
